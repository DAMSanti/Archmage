...
| Tests | **690**, todos en verde — 447 de `core`, 143 de `content`, 71 de `server`, 29 de `web` |
| `tsc -b` | sale **0** |
...
|---|---|---|
| La suite entera (690 tests) | — | **~14 s** |
...
**Las cuatro pasadas suman 73 comprobaciones** (24 + 19 + 15 + 15) y son la
