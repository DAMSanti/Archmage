...
export const CATALOG: Catalog = {
  ...
  units: {
    ...
    militia: {
      ...
      resistances: {}, spellResistances: {}, powerRank: 9,
    ...
    phalanx: {
      ...
      resistances: {}, spellResistances: {}, powerRank: 25,
    ...
    cavalry: {
      ...
      resistances: {}, spellResistances: {}, powerRank: 68,
    ...
    dryad: {
      ...
      resistances: { melee: 40 }, spellResistances: {}, powerRank: 23,
